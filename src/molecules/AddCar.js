...
const AddCar = () => {
 ...
 const { register: input, handleSubmit, setValue, formState: { errors } } = useForm({
  mode: "onChange",
 ...
 return (
  <div>
   ...
   <Container className='w-75'>
    ...
    <h4 className='fw-bold my-4'>Add New Car</h4>
    <p className='text-success'>{isSuccess}</p>
    <p className='text-success'>{isError}</p>
    <form onSubmit={handleSubmit(onSubmit)}>
     <div className="row align-items-center">
      <div className="col-auto w-14">
       <label htmlFor="name" className="form-label">Nama/Tipe Mobil <span>*</span></label>
      </div>
     ...
     <div className="row align-items-center py-3">
      <div className="col-auto w-14">
       <label htmlFor="harga" className="col-form-label">Harga <span>*</span></label>
      </div>
      <div className="col-auto">
     ...
     <div className="row align-items-center">
      <div className="col-auto w-14">
       <label htmlFor="foto" className="col-form-label">Foto <span>*</span></label>
      </div>
      <div className="col-auto">
     ...
     <div className="row align-items-center py-3">
      <div className="col-auto w-14">
       <label htmlFor="kategori" className="col-form-label">Kategori <span>*</span></label>
      </div>
      <div className="col-auto">
       <select className="form-select w-22" {...input("category")} onChange={(e) => setValue('category', e.target.value, { shouldValidate: true })}>
        <option defaultValue={'Pilih Kategori Mobil'} disabled>Pilih Kategori Mobil</option>
     ...
     <div className="row align-items-center py-3">
      <div className="col-auto w-14">
       <label htmlFor="harga" className="col-form-label">Created At</label>
      </div>
      <div className="col-auto">
       &nbsp;&nbsp;-
      </div>
     ...
     <div className="row align-items-center py-3">
      <div className="col-auto w-14">
       <label htmlFor="harga" className="col-form-label">Updated At</label>
      </div>
      <div className="col-auto">
       &nbsp;&nbsp;-
      </div>
     ...
     <div className='d-flex gap-3 fixed'>
      <Button onClick={() => navigate(-1)} className='btn btn-light'>Cancel</Button>
      <Button type='submit' disabled={isLoading}>{isLoading ? 'Loading..' : 'Save'}</Button>
     </div>
    </form>
   </Container>
  </div>
